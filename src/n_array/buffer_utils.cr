...
module Lattice
  ...
  class NArray(T)
    ...
    # `I` must be a CoordIndexIterator
    abstract class BufferedRegionIterator(A,T,I) < MultiIndexable::RegionIterator(A,T,I)
      def next
    ...
    class BufferedLexRegionIterator(A,T) < MultiIndexable::RegionIterator(A,T,IndexedLexIterator)
    end

    class BufferedColexRegionIterator(A,T) < MultiIndexable::RegionIterator(A,T,IndexedColexIterator)
    end
  end
end